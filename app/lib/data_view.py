...
class DataView:
    ...
    def select(self, where: str = '', values: dict = {}, group_by: str = '',
        ...
        lock : bool
            Acquire row level lock on selection
    ...
    def insert(self, values: dict, ret: str = None) -> Any:
        ...
        if ret is not None and ret in self.fields:
            query_tail = 'RETURNING {}'.format(ret)
    ...
    def update(self, values: dict, where=True, condition: dict = {},
               ret: str = None) -> Any:
